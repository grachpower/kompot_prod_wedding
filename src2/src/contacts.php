...
if (isset($_POST['submit'])) {
    ...
    $message_to_myemail = "Привет! Меня зовут $name, я представляю компанию $company, или пишу вам лично от себя, потому что планирую организовать $event. Меня заинтересовали ваши проекты особенно $interesting. Я узнал о вас, благодаря $informfrom. Свяжитесь со мной, пожалуйста,
